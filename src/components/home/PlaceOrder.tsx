...
export default function PlaceOrder() {
  return (
    <div
      ...
      className="w-full h-max bg-[#FF9702] flex justify-center bg-cover bg-no-repeat rounded-[32px] pt-[68px] pb-[74px] pl-[88px]"
    >
      <div className="2xl:w-[494px] w-[444px] flex flex-col items-center">
        ...
        <p className="text-center font-normal mb-5 2xl:mb-6 max-w-[414px] 2xl:max-w-[434px] text-[#5D5D5D] text-sm 2xl:text-base">
