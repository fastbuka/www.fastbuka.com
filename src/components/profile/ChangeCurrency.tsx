...
export default function ChangeCurrency() {
  ...
  return (
    <div className="relative @max-2xl:hidden w-max">
      <div
        onClick={() => {
      ...
      <AnimatePresence>
        {showDropdown && (
          <motion.div
            ...
            exit={{ opacity: 0 }}
            className="w-[223px] top-[calc(100%+10px)] p-2.5 absolute right-0 h-max border border-(--primary-green) rounded-[12px] bg-[#F6F6F6]"
          >
