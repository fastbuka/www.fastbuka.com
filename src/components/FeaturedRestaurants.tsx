        ...
        <div className='grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-6'>
          {isLoading || isFetching
            ? Array.from({ length: 10 }).map((_, index) => (
                <Skeleton key={index} loading={isLoading || isFetching}>
                  <div className='bg-[#B0E8D4] rounded-lg p-3 sm:p-4 md:p-6 text-center shadow-md flex items-center justify-center'>
