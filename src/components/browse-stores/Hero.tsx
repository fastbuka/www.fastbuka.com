  ...
  return (
    <div className="w-full @max-4xl:pt-6 pt-7 2xl:pt-10  h-max flex flex-col items-center">
      ...
      <div className="2xl:mt-10 mt-8 w-full @max-4xl:pb-3 max-w-[1250px] px-5 h-max pt-10 2xl:pt-12 pb-[56px] 2xl:pb-[76px] flex flex-col items-center">
        ...
        <div className="w-full max-w-[778px] pt-6 2xl:pt-8 flex flex-col items-center gap-4 2xl:gap-6">
          <p className="text-center font-medium text-[#111111] text-base 2xl:text-xl">
            Explore Categories
          </p>
          <div className="w-full p-2.5 grid grid-cols-6 gap-2.5">
            {categories.map((category, index) => {
              return (
                <button
                  key={index}
                  type="button"
                  className="col-span-1 cursor-pointer hover:opacity-70 duration-200 flex flex-col items-center justify-center gap-2.5 py-5 2xl:py-6 rounded-[12px] bg-[#EFFEF7]"
                >
                  <Image
